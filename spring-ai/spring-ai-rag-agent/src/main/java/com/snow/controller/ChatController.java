...
public class ChatController {
    ...
    @GetMapping("/ai/agent")
    public String agent(@RequestParam(value = "query", defaultValue = "张三有资格面试吗") String query) {
        //检索
        ...
        Prompt prompt = new Prompt(
                ...
                OpenAiChatOptions.builder().functions(Set.of("recruitServiceFunction")).build()
        );
        //调用
